...
const Modal = ({ options, children }: any) => {
  ...
  const classes = {
    ...
    info: "text-white bg-blue-500 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800",
    ...
    error:
      "focus:outline-none text-white bg-red-800 text-red hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-800 dark:focus:ring-red-900",
  };
  ...
  return (
    <>
      <div
        ...
        className={`${
          open ? "flex" : "hidden"
        } bg-white80 overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full`}
      >
        <div className="relative p-4 w-full md:w-[560px] max-h-full">
          <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div className="p-4 md:p-5 font-light">{children}</div>
                ...
                options.buttons.map((btn: any) => {
                  return (
                    <button
                      ...
                      key={btn.title}
                      type="button"
                      className={`${classes[btn.type as keyof Object]}`}
                    >
                      {btn.title}
                    </button>
                  );
