...
const EditProducts = () => {
  ...
  return (
    <div className="grow">
      <p className={styles.title}>Settings/Edit Product</p>
          ...
          <div>
            <div className={`flex gap-x-4`}>
              <div className="flex-1">
                <label className="mb-2" htmlFor="valid-from">From
                  <input type="datetime-local" id="valid-from" name="valid-from" className="border px-4 py-2 w-full mb-4 rounded-sm" />
                </label>
              </div>
              <div className="flex-1">
                <label className="mb-2" htmlFor="valid-to">To
                  <input type="datetime-local" name="valid-to" id="valid-to" className="border px-4 py-2 w-full mb-4 rounded-sm" />
                </label>
              </div>
            </div>
          </div>
