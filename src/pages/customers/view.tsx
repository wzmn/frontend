        ...
        {({ open }) => (
          ...
          <>
            ...
            <Disclosure.Panel className={styles.panel}>
              <div className={commonStyles.contactInfo}>
                <div className="">
                  <span className={commonStyles.icon}>
                    <TfiEmail className={commonStyles.icon} />
                  </span>

                  <span className={commonStyles.contact}>
                    {data?.user?.email}
                  </span>
                </div>
                ...
                <div className="">
                  <span className={commonStyles.icon}>
                    <IoCallOutline className={commonStyles.icon} />
                  </span>
